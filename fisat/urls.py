...
from .views import upload_document_view, create_document_view, delete_document_view, create_category_view, generate_lab_report_view, bulk_delete_documents_view
...
urlpatterns = [
    ...
    path('palette_allocate/<int:subject_id>/<int:staff_id>/', palette_allocate, name='palette_allocate'),
...
path('apply_ai_allocation/', apply_ai_allocation, name='apply_ai_allocation'),
    ...
    path('switch-semester/', switch_semester, name='switch_semester'),
    ...
    path('api/subject_entry/delete/<int:entry_id>/', delete_subject_entry_ajax, name='delete_subject_entry_ajax'),
    path('auto-lab-allotment/', auto_lab_allotment_view, name='auto_lab_allotment'),
    path('api/run-auto-lab-allotment/', api_run_auto_lab_allotment, name='api_run_auto_lab_allotment'),
    path('api/clear-all-allotments/', api_clear_all_allotments, name='api_clear_all_allotments'),
    ...
    path('document/bulk-delete/', bulk_delete_documents_view, name='bulk_delete_documents'),
